...
//     ambient_ptr->scale_radiance(1.5);               // for Olympics
//    background_color = RGBColor(0.9, 0.9, 0.9);	// for Olympics
    tracer_ptr = new RayCast(this);

   Directional* lt = new Directional();
   lt->set_shadows(true);

   // { // spheres and cityview
   //     lt->set_direction(300, 100, 200);
   //     lt->scale_radiance(7.0);
   // }

   // { // practical
   //   lt->set_direction(-30, -50, 60);   // 11 o'clock
   //   lt->scale_radiance(5);
   // }
...
void World::build() {
   ...
   // for this one,
   // set all lights, camera, etc.
   // in the build_sphere_triangle_box_world()
   // build_sphere_triangle_box(this);   // TODO:  fill in code in Worlds.cpp, adjust lights and cameras, and run
